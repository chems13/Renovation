import douche from "../../assets/douche.jpg";
export default function ChantierForm({
  ...
  return (
    <div className="container m-2">
      <div className="row">
        <div className="card p-4 mb-4 col-md-6">
        ...
        <div className="col-md-6">
          <section className="p-4 mb-4 card">
            <h3 className="fw-bold text-center">Nos chantiers</h3>
            <p>
              Découvrez nos chantiers réalisés dans les Bouches‑du‑Rhône. Pour
              toute demande d’information, contactez‑nous par mail ou par
              téléphone.
            </p>
            <img
              src={douche}
